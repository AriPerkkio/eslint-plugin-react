...
- Path: `gpbl/isomorphic500/src/server.js`
- [Link](https://github.com/gpbl/isomorphic500/blob/HEAD/src/server.js)
```js
...
- Path: `gpbl/isomorphic500/webpack/server.js`
- [Link](https://github.com/gpbl/isomorphic500/blob/HEAD/webpack/server.js)
```js
TypeError: Cannot read property 'type' of null
Occurred while linting <text>:21
    at isReactComponentName (<removed-path>/eslint-plugin-react/lib/rules/no-reference-type-as-default-prop.js:24:15)
