...
- Path: `rsuite/rsuite/examples/with-umi/src/pages/index.js`
- [Link](https://github.com/rsuite/rsuite/blob/HEAD/examples/with-umi/src/pages/index.js)
```js
...
- Path: `rsuite/rsuite/test/getPalette.js`
- [Link](https://github.com/rsuite/rsuite/blob/HEAD/test/getPalette.js)
```js
TypeError: Cannot read property 'type' of null
Occurred while linting <text>:12
    at isReactComponentName (<removed-path>/eslint-plugin-react/lib/rules/no-reference-type-as-default-prop.js:24:15)
