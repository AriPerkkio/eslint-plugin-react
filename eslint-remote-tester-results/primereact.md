...
- Path: `primefaces/primereact/src/components/utils/UniqueComponentId.js`
- [Link](https://github.com/primefaces/primereact/blob/HEAD/src/components/utils/UniqueComponentId.js)
```js
