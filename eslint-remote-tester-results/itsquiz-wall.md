...
- Path: `WebbyLab/itsquiz-wall/shared/api/index.js`
- [Link](https://github.com/WebbyLab/itsquiz-wall/blob/HEAD/shared/api/index.js)
```js
...
- Path: `WebbyLab/itsquiz-wall/shared/utils/isIOSDevice.js`
- [Link](https://github.com/WebbyLab/itsquiz-wall/blob/HEAD/shared/utils/isIOSDevice.js)
```js
TypeError: Cannot read property 'type' of null
Occurred while linting <text>:3
    at isReactComponentName (<removed-path>/eslint-plugin-react/lib/rules/no-reference-type-as-default-prop.js:24:15)
