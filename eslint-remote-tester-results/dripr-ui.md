...
- Path: `DevAlien/dripr-ui/server/render.js`
- [Link](https://github.com/DevAlien/dripr-ui/blob/HEAD/server/render.js)
```js
...
- Path: `DevAlien/dripr-ui/src/store/middlewares.js`
- [Link](https://github.com/DevAlien/dripr-ui/blob/HEAD/src/store/middlewares.js)
```js
TypeError: Cannot read property 'type' of null
Occurred while linting <text>:5
    at isReactComponentName (<removed-path>/eslint-plugin-react/lib/rules/no-reference-type-as-default-prop.js:24:15)
